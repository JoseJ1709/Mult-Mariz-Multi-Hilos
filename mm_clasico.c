...
int main(int argc, char *argv[]){
    // Comprueba si se proporcionan suficientes argumentos de línea de comandos
	if (argc < 2){
		printf("Ingreso de argumentos \n $./ejecutable tamMatriz numHilos\n");
		return -1;	
	}
    // Obtiene comandos para el tamaño de la matriz y el número de hilos
    int SZ = atoi(argv[1]);
